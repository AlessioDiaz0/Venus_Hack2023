...
export default function Quizzes() {
    ...
    const flashcard = () => {
        router.push("/dashboard/language/flashCards");
    }
    React.useEffect(() => {
        setCurrentWord("Quiz1");
        setCurrentTrans("Translation1");
                ...
                <div class="flip-card">
                    <div class="flip-card-inner">
                        <div class="flip-card-front">
                            <h2 class="bg-white py-64 px-80 rounded-xl text-indigo-950 text-4xl flex justify-center" >{currentWord}</h2>
                        </div>
                        <div class="flip-card-back">
                            <h2 class="bg-white py-64 px-80 rounded-xl text-indigo-950 text-4xl flex justify-center">{currentTrans}</h2>
                        </div>
                    </div>
                </div>
            </div>
